...
def Result_dis():
    ...
    ddf = pd.read_excel("C:\DataBase\Discharge_rate_Capability\Discharge_rate_Capability_Spec.xlsx", sheetname="Spec",
                        encoding="cp932")
    ...
    def All1():
        ...
        while color_list1.count("") > 0:
            color_list1.remove("")
        color_list2 = [color1_1.get(), color1_2.get(), color1_3.get(), color1_4.get(), color1_5.get(),
                       color1_6.get()]  # 行に並ぶカーブデータ
    ...
    color_box1 = ttk.Combobox(root, values=List_color, textvariable=color1, state="normal", width=13).grid(row=4,
                                                                                                           column=1)
    color_box2 = ttk.Combobox(root, values=List_color, textvariable=color2, state="normal", width=13).grid(row=5,
                                                                                                           column=1)
    color_box3 = ttk.Combobox(root, values=List_color, textvariable=color3, state="normal", width=13).grid(row=6,
                                                                                                           column=1)
    color_box4 = ttk.Combobox(root, values=List_color, textvariable=color4, state="normal", width=13).grid(row=7,
                                                                                                           column=1)
    color_box5 = ttk.Combobox(root, values=List_color, textvariable=color5, state="normal", width=13).grid(row=8,
                                                                                                           column=1)
    color_box6 = ttk.Combobox(root, values=List_color, textvariable=color6, state="normal", width=13).grid(row=9,
                                                                                                           column=1)

    color_box1_1 = ttk.Combobox(root, values=List_color, textvariable=color1_1, state="normal", width=10).grid(row=3,
                                                                                                               column=3)
    color_box2_1 = ttk.Combobox(root, values=List_color, textvariable=color1_2, state="normal", width=10).grid(row=3,
                                                                                                               column=4)
    color_box3_1 = ttk.Combobox(root, values=List_color, textvariable=color1_3, state="normal", width=10).grid(row=3,
                                                                                                               column=5)
    color_box4_1 = ttk.Combobox(root, values=List_color, textvariable=color1_4, state="normal", width=10).grid(row=3,
                                                                                                               column=6)
    color_box5_1 = ttk.Combobox(root, values=List_color, textvariable=color1_5, state="normal", width=10).grid(row=3,
                                                                                                               column=7)
    color_box6_1 = ttk.Combobox(root, values=List_color, textvariable=color1_6, state="normal", width=10).grid(row=3,
                                                                                                               column=8)

    class_box1 = ttk.Combobox(root, values=List_cell_Lot, textvariable=class1, state="normal", width=16).grid(row=4,
                                                                                                              column=2)
    class_box2 = ttk.Combobox(root, values=List_cell_Lot, textvariable=class2, state="normal", width=16).grid(row=5,
                                                                                                              column=2)
    class_box3 = ttk.Combobox(root, values=List_cell_Lot, textvariable=class3, state="normal", width=16).grid(row=6,
                                                                                                              column=2)
    class_box4 = ttk.Combobox(root, values=List_cell_Lot, textvariable=class4, state="normal", width=16).grid(row=7,
                                                                                                              column=2)
    class_box5 = ttk.Combobox(root, values=List_cell_Lot, textvariable=class5, state="normal", width=16).grid(row=8,
                                                                                                              column=2)
    class_box6 = ttk.Combobox(root, values=List_cell_Lot, textvariable=class6, state="normal", width=16).grid(row=9,
                                                                                                              column=2)

    Rate_box1_1 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate1_1, state="normal", width=10).grid(
        row=4, column=3)
    Rate_box2_1 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate2_1, state="normal", width=10).grid(
        row=5, column=3)
    Rate_box3_1 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate3_1, state="normal", width=10).grid(
        row=6, column=3)
    Rate_box4_1 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate4_1, state="normal", width=10).grid(
        row=7, column=3)
    Rate_box5_1 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate5_1, state="normal", width=10).grid(
        row=8, column=3)
    Rate_box6_1 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate6_1, state="normal", width=10).grid(
        row=9, column=3)

    Rate_box1_2 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate1_2, state="normal", width=10).grid(
        row=4, column=4)
    Rate_box2_2 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate2_2, state="normal", width=10).grid(
        row=5, column=4)
    Rate_box3_2 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate3_2, state="normal", width=10).grid(
        row=6, column=4)
    Rate_box4_2 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate4_2, state="normal", width=10).grid(
        row=7, column=4)
    Rate_box5_2 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate5_2, state="normal", width=10).grid(
        row=8, column=4)
    Rate_box6_2 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate6_2, state="normal", width=10).grid(
        row=9, column=4)

    Rate_box1_3 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate1_3, state="normal", width=10).grid(
        row=4, column=5)
    Rate_box2_3 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate2_3, state="normal", width=10).grid(
        row=5, column=5)
    Rate_box3_3 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate3_3, state="normal", width=10).grid(
        row=6, column=5)
    Rate_box4_3 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate4_3, state="normal", width=10).grid(
        row=7, column=5)
    Rate_box5_3 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate5_3, state="normal", width=10).grid(
        row=8, column=5)
    Rate_box6_3 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate6_3, state="normal", width=10).grid(
        row=9, column=5)

    Rate_box1_4 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate1_4, state="normal", width=10).grid(
        row=4, column=6)
    Rate_box2_4 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate2_4, state="normal", width=10).grid(
        row=5, column=6)
    Rate_box3_4 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate3_4, state="normal", width=10).grid(
        row=6, column=6)
    Rate_box4_4 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate4_4, state="normal", width=10).grid(
        row=7, column=6)
    Rate_box5_4 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate5_4, state="normal", width=10).grid(
        row=8, column=6)
    Rate_box6_4 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate6_4, state="normal", width=10).grid(
        row=9, column=6)

    Rate_box1_5 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate1_5, state="normal", width=10).grid(
        row=4, column=7)
    Rate_box2_5 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate2_5, state="normal", width=10).grid(
        row=5, column=7)
    Rate_box3_5 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate3_5, state="normal", width=10).grid(
        row=6, column=7)
    Rate_box4_5 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate4_5, state="normal", width=10).grid(
        row=7, column=7)
    Rate_box5_5 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate5_5, state="normal", width=10).grid(
        row=8, column=7)
    Rate_box6_5 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate6_5, state="normal", width=10).grid(
        row=9, column=7)

    Rate_box1_6 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate1_6, state="normal", width=10).grid(
        row=4, column=8)
    Rate_box2_6 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate2_6, state="normal", width=10).grid(
        row=5, column=8)
    Rate_box3_6 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate3_6, state="normal", width=10).grid(
        row=6, column=8)
    Rate_box4_6 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate4_6, state="normal", width=10).grid(
        row=7, column=8)
    Rate_box5_6 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate5_6, state="normal", width=10).grid(
        row=8, column=8)
    Rate_box6_6 = ttk.Combobox(root, values=List_capa_Reference2, textvariable=Rate6_6, state="normal", width=10).grid(
        row=9, column=8)
...
def import_aci():
    ...
    def ACI_import():
        ...
        root = tkinter.Tk()
        root.withdraw()
        args = askopenfilenames(
            filetypes=(("All files", "*.*"), ("HTML files", "*.html;*.htm"), ("csv files", "*.csv")))
        args_size = len(args)
        ...
        for i in range(args_size):
            ...
            for j in range(Len_column):
                ...
                save_file = "C:\DataBase\ACI\Data" + "\ACI_" + NAME3 + "_" + CONDITION + "_" + EQ + "_" + TEMP + "deg.C_" + SIZE + "_" + str(
                    VOLTAGE) + "V_" + str(NAME4) + "cyc_" + str(capa) + "mAh" + "_Data.csv"  # Rawデータのリンク
                Raw_file = "C:\DataBase\ACI\Raw" + "\ACI_" + NAME3 + "_" + CONDITION + "_" + EQ + "_" + TEMP + "deg.C_" + SIZE + "_" + str(
                    VOLTAGE) + "V_" + str(NAME4) + "cyc_" + str(capa) + "mAh" + "_Raw.csv"  # Rawデータのリンク
                ...
                def Raw(x):
                    df3 = df.iloc[0:-1, x * 6:x * 6 + 6]
                    df3.columns = ["Frequency[Hz]", "Z'[mohm]", "Z''[mohm]", "theta[rad]", "|Z|[mohm]",
                                   "delta|Z|/delta(logf)[mohm]"]
                    df3 = df3.dropna(axis=0)
                    return df3
    ...
    List_name_cyc = ["2G_25degC", "2G_35degC", "2G_45degC", "VAC_25degC", "VAC_35degC", "VAC_40degC", "VAC_45degC"
        , "D3x_25degC", "D3x_35degC", "D3x_45degC", "Hw3step_23degC", "Hw3step_45degC", "Rest_cycle_RT",
                     "Rest_cycle_45degC"
        , "Hw1.3Cstep_23degC", "Hw1.3Cstep_45degC", "2G_23degC", "2G_RT", "0510_25degC", "0510_45degC", "0910_25degC",
                     "after-xx"]
...
def float_result2():
    ...
    def hot():
        ...
        color_list1 = [color1.get(), color2.get(), color3.get(), color4.get(), color5.get(), color6.get(),
                       color7.get(), color8.get(), color9.get(), color10.get(), color11.get(),
                       color12.get()]  # 列に並ぶカーブデータ
        while color_list1.count("") > 0:
            color_list1.remove("")
        ...
        DF = df1[["Cell-Lot", "Floating-time[h]", "thickness-plate[%]_300g_initial",
                  "thickness-plate[%]_300g_full_Charge-initial"]]
        num = len(Lot_list)
        for i in range(num):
    ...
    def cold():
        ...
        while Lot_list.count("") > 0:
            Lot_list.remove("")
        plate_label = "thickness-plate[%]_300g_" + initial
        DF = df2[["Cell-Lot", "Floating-time[h]", "thickness-plate[%]_300g_initial",
                  "thickness-plate[%]_300g_full_Charge-initial"]]
        num = len(Lot_list)
        for i in range(num):
            DF1 = DF[DF["Cell-Lot"] == Lot_list[i]]
    ...
    def hot_cold():
        ...
        plate_label = "thickness-plate[%]_300g_" + initial
        num = len(Lot_list)
        ddf1 = df1[["Cell-Lot", "Floating-time[h]", "thickness-plate[%]_300g_initial",
                    "thickness-plate[%]_300g_full_Charge-initial"]]
        ddf2 = df2[["Cell-Lot", "Floating-time[h]", "thickness-plate[%]_300g_initial",
                    "thickness-plate[%]_300g_full_Charge-initial"]]
        for i in range(num):
